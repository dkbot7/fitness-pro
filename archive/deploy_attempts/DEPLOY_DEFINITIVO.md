...
## [OK] Mudanças Aplicadas

1. [OK] Removido `output: 'standalone'` do next.config.ts
2. [OK] Adicionado `images: { unoptimized: true }` (necessário para Cloudflare)
3. [OK] Configuração simplificada sem OpenNext
4. [OK] PWA mantido funcionando

---

## [SETTINGS] CONFIGURAÇÃO DEFINITIVA (Cloudflare Pages Dashboard)
...
- [OK] Usa preset Next.js nativo do Cloudflare
- [OK] Sem adapters complexos (OpenNext, etc)
- [OK] Next.js 15 tem suporte nativo para edge runtime
- [OK] Cloudflare Pages reconhece `.next` automaticamente
- [OK] Images unoptimized (Cloudflare não suporta next/image otimizado)
