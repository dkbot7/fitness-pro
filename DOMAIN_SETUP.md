...
## ✅ Passo 1: Adicionar ao Cloudflare
...
⚠️ **ATENÇÃO**: A GoDaddy pode mostrar um aviso que você perderá o gerenciamento DNS. Isso é normal - você gerenciará via Cloudflare agora.
...
Proxied: ✅ Sim (nuvem laranja ativa)
TTL: Auto
```
