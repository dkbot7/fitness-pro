...
### 1. **Autenticação JWT Insegura** ⚠️ BLOQUEADOR
...
## ⚠️ ALTO - Problemas que Bloqueiam Deploy

### 5. **Ícone PWA Faltando**
**Localização**: `apps/web/public/`

- ✅ Existe: `icon-192x192.png`
- ❌ **Faltando**: `icon-512x512.png` (referenciado no manifest.json:18)
...
**Status atual**:
- ✅ `apps/web/src/app/(dashboard)/plano/loading.tsx` - Existe
- ✅ `apps/web/src/app/(dashboard)/treino/[id]/loading.tsx` - Existe
- ✅ `apps/web/src/app/(dashboard)/perfil/loading.tsx` - Existe
...
1. ✅ **Segurança JWT** (8-12h) - PRIORIDADE #1
2. ✅ **Corrigir erros TypeScript** (4-8h)
3. ✅ **Testes básicos** (12-16h) - Pelo menos handlers principais
4. ✅ **Configurar secrets produção** (2h)
