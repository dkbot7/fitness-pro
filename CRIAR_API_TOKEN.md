...
### O token permite:
- ✅ Adicionar domínios ao Pages project
- ✅ Modificar configurações do Pages
- ✅ Configurar DNS records (se necessário)
- ❌ NÃO permite: deletar projetos, modificar billing, etc.
...
Vou te informar:
- ✅ Status de cada domínio (Active/Pending)
- ✅ DNS records criados
- ✅ SSL status
- ✅ Tempo estimado para propagação
- ✅ Links para testar
